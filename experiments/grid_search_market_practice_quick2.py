#!/usr/bin/env python3
"""
Test a grid of SL and TP parameters on a very small set.
- Stop loss: -5, -6, -7, -8
- Take profit first: 10, 12, 14 -> second: first + 5 (15, 17, 19)
- Max holding days: 2, 3, 4
- Stocks: first 2 of KOSPI Top 50
- Days: last 2 days
"""
import sys
import json
...
def main():
    ...
    # Save results
    out_path = Path('/home/june/trading/reports/grid_search_market_practice_quick2.json')
