#!/usr/bin/env python3
"""
Backtest Fujimoto 1-2-6 strategy with custom rules:
...
def main():
    ...
    # Save results
    out_path = Path('/home/june/trading/reports/fujimoto_126_backtest_custom_swing_no_time_exit.json')
