#!/usr/bin/env python3
"""
Quick test of the re-entry logic on a single stock and a few days.
"""
import sys
import json
...
def main():
    ...
    # Test just one stock: SK텔레콤 (017670) which we know had good data
    stock_code = "017670"
    ...
    # Save results
    out_path = Path('/home/june/trading/reports/fujimoto_126_backtest_custom_swing_with_reentry_quick.json')
