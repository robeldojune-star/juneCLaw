...
with open('/home/june/trading/core/fujimoto_126_filter.py.backup', 'r') as f:
    lines = f.readlines()

# Find the line where the simulate function starts
start_idx = None
...
if start_idx is None:
    print("Could not find simulate_fujimoto_126_trade function")
    sys.exit(1)

# Keep everything before the function
new_lines = lines[:start_idx]

# Append the new simulate function
new_lines.append('''def simulate_fujimoto_126_trade(
    bars: list[PriceBar],
    *,
...
# Write back
with open('/home/june/trading/core/fujimoto_126_filter.py', 'w') as f:
