...
def replace_simulate_function():
    ...
    # Find start and end of the old simulate_fujimoto_126_trade function
    start_idx = -1
    ...
    if start_idx == -1:
        print("Error: Could not find simulate_fujimoto_126_trade function")
        return False
...
'''
    ...
    print("Successfully replaced simulate_fujimoto_126_trade function")
    return True

if __name__ == '__main__':
    if replace_simulate_function():
        sys.exit(0)
    else:
        sys.exit(1)