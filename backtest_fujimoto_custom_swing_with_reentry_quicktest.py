#!/usr/bin/env python3
"""
Quick test of the re-entry logic using actual KOSPI Top 50 list but limited scope.
"""
import sys
import json
import csv
...
def main():
    ...
    # Take first 5 stocks from the list for quick test
    stock_codes = KOSPI_TOP_50[:5]
    print("Testing stocks:", stock_codes)
    ...
    # Save results
    out_path = Path('/home/june/trading/reports/fujimoto_126_backtest_custom_swing_with_reentry_quicktest.json')
